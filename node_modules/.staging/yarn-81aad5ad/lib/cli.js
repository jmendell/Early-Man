...
function _load_map() {
  return _map = _interopRequireDefault(__webpack_require__(33));
}

var _set;

function _load_set() {
  return _set = _interopRequireDefault(__webpack_require__(11));
}
...
function _load_promise() {
  return _promise = _interopRequireDefault(__webpack_require__(4));
}
...
let buildActionsForCopy = (() => {
  var _ref2 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (queue, events, possibleExtraneous, reporter) {
    ...
    //
    let build = (() => {
      var _ref3 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (data) {
        const src = data.src,
              dest = data.dest,
              type = data.type;
...
let copyBulk = exports.copyBulk = (() => {
  var _ref7 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (queue, reporter, _events) {
    ...
    const currentlyWriting = new (_map || _load_map()).default();
...
let hardlinkBulk = exports.hardlinkBulk = (() => {
  var _ref9 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (queue, reporter, _events) {
    const events = {
      onStart: _events && _events.onStart || noop,
      onProgress: _events && _events.onProgress || noop,
      possibleExtraneous: _events ? _events.possibleExtraneous : new (_set || _load_set()).default(),
    ...
    yield (_promise2 || _load_promise2()).queue(fileActions, (() => {
      var _ref10 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (data) {
...
let readFileAny = exports.readFileAny = (() => {
  var _ref11 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (files) {
...
let walk = exports.walk = (() => {
  ...
  return function walk(_x33, _x34) {
...
let getFileSizeOnDisk = exports.getFileSizeOnDisk = (() => {
  ...
  return function getFileSizeOnDisk(_x35) {
...
let getEolFromFile = (() => {
  ...
  return function getEolFromFile(_x36) {
...
let writeFilePreservingEol = exports.writeFilePreservingEol = (() => {
  ...
  return function writeFilePreservingEol(_x37, _x38) {
...
let hardlinksWork = exports.hardlinksWork = (() => {
  ...
  return function hardlinksWork(_x39) {
...
let makeTempDir = exports.makeTempDir = (() => {
  ...
  return function makeTempDir(_x40) {
    return _ref21.apply(this, arguments);
  };
})();

let readFirstAvailableStream = exports.readFirstAvailableStream = (() => {
  var _ref22 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (paths) {
    var _this = this;
    ...
    return { stream: stream, triedPaths: triedPaths };
  });

  return function readFirstAvailableStream(_x41) {
    return _ref22.apply(this, arguments);
  };
})();

let getFirstSuitableFolder = exports.getFirstSuitableFolder = (() => {
  var _ref23 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (paths) {
    let mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : constants.W_OK | constants.X_OK;
  ...
  return function getFirstSuitableFolder(_x43) {
...
function _load_glob() {
  return _glob = _interopRequireDefault(__webpack_require__(170));
}

var _os;

function _load_os() {
  return _os = _interopRequireDefault(__webpack_require__(75));
}

var _path;

function _load_path() {
  return _path = _interopRequireDefault(__webpack_require__(1));
}

var _blockingQueue;

function _load_blockingQueue() {
  return _blockingQueue = _interopRequireDefault(__webpack_require__(102));
}
...
function _load_map2() {
  return _map2 = _interopRequireDefault(__webpack_require__(28));
}
...
const readFileBuffer = exports.readFileBuffer = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.readFile);
const writeFile = exports.writeFile = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.writeFile);
const readlink = exports.readlink = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.readlink);
const realpath = exports.realpath = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.realpath);
const readdir = exports.readdir = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.readdir);
const rename = exports.rename = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.rename);
const access = exports.access = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.access);
const stat = exports.stat = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.stat);
const unlink = exports.unlink = (0, (_promise3 || _load_promise3()).promisify)(__webpack_require__(662));
const mkdirp = exports.mkdirp = (0, (_promise3 || _load_promise3()).promisify)(__webpack_require__(180));
const exists = exports.exists = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.exists, true);
const lstat = exports.lstat = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.lstat);
const chmod = exports.chmod = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.chmod);
const link = exports.link = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.link);
const glob = exports.glob = (0, (_promise3 || _load_promise3()).promisify)((_glob || _load_glob()).default);
...
const open = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.open);
const close = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.close);
const write = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.write);
const futimes = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.futimes);
...
(src, dest, flags, data) => new (_promise || _load_promise()).default((resolve, reject) => (_fs || _load_fs()).default.copyFile(src, dest, flags, err => err ? reject(err) : resolve(err))) : (() => {
...
const fsSymlink = (0, (_promise3 || _load_promise3()).promisify)((_fs || _load_fs()).default.symlink);
const invariant = __webpack_require__(6);
const stripBOM = __webpack_require__(303);
 ...
 */
const safeCopyFile = (() => {
  var _ref6 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (data, cleanup) {
    try {
      yield unlink(data.dest);
...
const userHome = __webpack_require__(86).default;
const isWebpackBundle = __webpack_require__(598);
...
const MANIFEST_FIELDS = exports.MANIFEST_FIELDS = [RESOLUTIONS].concat(DEPENDENCY_TYPES);
...
const _camelCase = __webpack_require__(443);
...
function _load_keys() {
  return _keys = _interopRequireDefault(__webpack_require__(10));
}

var _parse;

function _load_parse() {
  return _parse = __webpack_require__(222);
}
...
function _load_stringify() {
  return _stringify = __webpack_require__(400);
}
...
function _load_misc() {
  return _misc = __webpack_require__(15);
}

var _normalizePattern;

function _load_normalizePattern() {
  return _normalizePattern = __webpack_require__(39);
}

var _parse2;

function _load_parse2() {
  return _parse2 = _interopRequireDefault(__webpack_require__(222));
}
...
var _getIterator2 = __webpack_require__(434);
...
var PrivateKey = __webpack_require__(24);
...
function calculateDSAPublic(g, p, x) {
	...
	assert.buffer(x);
	try {
		var bigInt = __webpack_require__(57).BigInteger;
	} catch (e) {
...
var assert = __webpack_require__(12);
var algs = __webpack_require__(22);
var crypto = __webpack_require__(9);
var Fingerprint = __webpack_require__(95);
var Signature = __webpack_require__(43);
var DiffieHellman = __webpack_require__(298).DiffieHellman;
var errs = __webpack_require__(42);
var utils = __webpack_require__(20);
var PrivateKey = __webpack_require__(24);
var edCompat;

try {
	edCompat = __webpack_require__(299);
} catch (e) {
...
var formats = {};
formats['auto'] = __webpack_require__(300);
formats['pem'] = __webpack_require__(58);
formats['pkcs1'] = __webpack_require__(184);
formats['pkcs8'] = __webpack_require__(96);
formats['rfc4253'] = __webpack_require__(63);
formats['ssh'] = __webpack_require__(301);
formats['ssh-private'] = __webpack_require__(128);
...
var util = __webpack_require__(2);
var utils = __webpack_require__(20);
var dhe = __webpack_require__(298);
...
function _load_extends() {
  return _extends2 = _interopRequireDefault(__webpack_require__(29));
}

var _toConsumableArray2;

function _load_toConsumableArray() {
  return _toConsumableArray2 = _interopRequireDefault(__webpack_require__(32));
}

var _assign;

function _load_assign() {
  return _assign = _interopRequireDefault(__webpack_require__(13));
}
...
let install = exports.install = (() => {
  var _ref11 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (config, reporter, flags, lockfile) {
  ...
  return function install(_x17, _x18, _x19, _x20) {
    return _ref11.apply(this, arguments);
  };
})();
...
let wrapLifecycle = exports.wrapLifecycle = (() => {
  var _ref14 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (config, flags, factory) {
...
function _load_index() {
  return _index = _interopRequireDefault(__webpack_require__(150));
}
...
function _load_integrityChecker() {
  return _integrityChecker = _interopRequireDefault(__webpack_require__(141));
}

var _lockfile;

function _load_lockfile() {
  return _lockfile = _interopRequireDefault(__webpack_require__(16));
}

var _lockfile2;

function _load_lockfile2() {
  return _lockfile2 = __webpack_require__(16);
}

var _packageFetcher;

function _load_packageFetcher() {
  return _packageFetcher = _interopRequireWildcard(__webpack_require__(224));
}

var _packageInstallScripts;

function _load_packageInstallScripts() {
  return _packageInstallScripts = _interopRequireDefault(__webpack_require__(403));
}

var _packageCompatibility;

function _load_packageCompatibility() {
  return _packageCompatibility = _interopRequireWildcard(__webpack_require__(223));
}

var _packageResolver;

function _load_packageResolver() {
  return _packageResolver = _interopRequireDefault(__webpack_require__(225));
}

var _packageLinker;

function _load_packageLinker() {
  return _packageLinker = _interopRequireDefault(__webpack_require__(142));
}

var _index2;

function _load_index2() {
  return _index2 = __webpack_require__(37);
}

var _index3;

function _load_index3() {
  return _index3 = __webpack_require__(38);
}

var _autoclean;

function _load_autoclean() {
  return _autoclean = __webpack_require__(213);
}

var _constants;

function _load_constants() {
  return _constants = _interopRequireWildcard(__webpack_require__(7));
}
...
function _load_yarnVersion() {
  return _yarnVersion = __webpack_require__(76);
}
...
function _load_resolutionMap() {
  return _resolutionMap = _interopRequireDefault(__webpack_require__(228));
}
...
const emoji = __webpack_require__(280);
...
class Install {
  ...
  fetchRequestFromCwd() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (const registry of (0, (_keys || _load_keys()).default)((_index2 || _load_index2()).registries)) {
        ...
        for (const packageName of (0, (_keys || _load_keys()).default)(_this.resolutionMap.resolutionsByPackage)) {
          for (const _ref of _this.resolutionMap.resolutionsByPackage[packageName]) {
            const pattern = _ref.pattern;

            resolutionDeps = [].concat((0, (_toConsumableArray2 || _load_toConsumableArray()).default)(resolutionDeps), [{ registry: registry, pattern: pattern, optional: false, hint: 'resolution' }]);
          }
        }

        const pushDeps = function pushDeps(depType, manifest, _ref2, isUsed) {
          let hint = _ref2.hint,
          ...
          for (const name in depMap) {
            ...
            deps.push({ pattern: pattern, registry: registry, hint: hint, optional: optional, workspaceName: manifest.name, workspaceLoc: manifest._loc });
          }
        };
        ...
        if (_this.config.workspaceRootFolder) {
          ...
          for (const workspaceName of (0, (_keys || _load_keys()).default)(workspaces)) {
      ...
      return {
        requests: [].concat((0, (_toConsumableArray2 || _load_toConsumableArray()).default)(resolutionDeps), deps),
        patterns: patterns,
        manifest: manifest,
  ...
  init() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      if (yield (_fs || _load_fs()).exists(path.join(_this4.config.lockfileFolder, 'npm-shrinkwrap.json'))) {
      ...
      var _ref3 = yield _this4.fetchRequestFromCwd();

      const depRequests = _ref3.requests,
            rawPatterns = _ref3.patterns,
            ignorePatterns = _ref3.ignorePatterns,
      ...
      if (!_this4.flags.ignoreEngines && typeof manifest.engines === 'object') {
        steps.push((() => {
          var _ref4 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (curr, total) {
            _this4.reporter.step(curr, total, _this4.reporter.lang('checkingManifest'), emoji.get('mag'));
            yield (_packageCompatibility || _load_packageCompatibility()).checkOne((0, (_extends2 || _load_extends()).default)({ _reference: {} }, manifest), _this4.config, _this4.flags.ignoreEngines);
          });
      ...
      steps.push((() => {
        var _ref5 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (curr, total) {
          ...
          _this4.resolutionMap.setTopLevelPatterns(rawPatterns);
      ...
      steps.push((() => {
        var _ref7 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (curr, total) {
          ...
          yield _this4.linker.init(flattenedTopLevelPatterns, workspaceLayout, {
            linkDuplicates: _this4.flags.linkDuplicates,
            ignoreOptional: _this4.flags.ignoreOptional
          });
        });
      ...
      if (yield _this4.shouldClean()) {
        steps.push((() => {
          var _ref10 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (curr, total) {
            _this4.reporter.step(curr, total, _this4.reporter.lang('cleaningModules'), emoji.get('recycle'));
            yield (0, (_autoclean || _load_autoclean()).clean)(_this4.config, _this4.reporter);
          });
      ...
      if (topLevelPatterns.length || (yield (_fs || _load_fs()).exists(path.join(_this4.config.lockfileFolder, (_constants || _load_constants()).LOCKFILE_FILENAME)))) {
        yield _this4.saveLockfileAndIntegrity(topLevelPatterns, workspaceLayout);
      } else {
        _this4.reporter.info(_this4.reporter.lang('notSavedLockfileNoDependencies'));
      }
      _this4.maybeOutputUpdate();
  ...
  saveLockfileAndIntegrity(patterns, workspaceLayout) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      (0, (_keys || _load_keys()).default)(_this7.resolver.patterns).forEach(function (pattern) {
      ...
      const lockfilePatternsMatch = (0, (_keys || _load_keys()).default)(_this7.lockfile.cache || {}).every(function (p) {
        return lockfileBasedOnResolver[p];
      });
      const resolverPatternsAreSameAsInLockfile = (0, (_keys || _load_keys()).default)(lockfileBasedOnResolver).every(function (pattern) {
      ...
      if (!_this7.flags.force && _this7.lockfile.parseResultType === 'success' && lockFileHasAllPatterns && lockfilePatternsMatch && resolverPatternsAreSameAsInLockfile && patterns.length) {
        return;
      }
      ...
      // write lockfile
      const lockSource = (0, (_lockfile2 || _load_lockfile2()).stringify)(lockfileBasedOnResolver, false, _this7.config.enableLockfileVersions);
...
function _load_setPrototypeOf() {
  return _setPrototypeOf = _interopRequireDefault(__webpack_require__(436));
}
...
var escapeStringRegexp = __webpack_require__(167);
var ansiStyles = __webpack_require__(583);
var stripAnsi = __webpack_require__(173);
var hasAnsi = __webpack_require__(556);
var supportsColor = __webpack_require__(586);
...
function _load_yarnRegistry() {
  return _yarnRegistry = _interopRequireDefault(__webpack_require__(406));
}

var _npmRegistry;

function _load_npmRegistry() {
  return _npmRegistry = _interopRequireDefault(__webpack_require__(48));
}
...
function _load_baseResolver() {
  return _baseResolver = _interopRequireDefault(__webpack_require__(81));
}

var _npmResolver;

function _load_npmResolver() {
  return _npmResolver = _interopRequireDefault(__webpack_require__(147));
}

var _yarnResolver;

function _load_yarnResolver() {
  return _yarnResolver = _interopRequireDefault(__webpack_require__(231));
}

var _gitResolver;

function _load_gitResolver() {
  return _gitResolver = _interopRequireDefault(__webpack_require__(82));
}

var _tarballResolver;

function _load_tarballResolver() {
  return _tarballResolver = _interopRequireDefault(__webpack_require__(419));
}

var _githubResolver;

function _load_githubResolver() {
  return _githubResolver = _interopRequireDefault(__webpack_require__(229));
}

var _fileResolver;

function _load_fileResolver() {
  return _fileResolver = _interopRequireDefault(__webpack_require__(145));
}

var _linkResolver;

function _load_linkResolver() {
  return _linkResolver = _interopRequireDefault(__webpack_require__(230));
}

var _gitlabResolver;

function _load_gitlabResolver() {
  return _gitlabResolver = _interopRequireDefault(__webpack_require__(417));
}

var _gistResolver;

function _load_gistResolver() {
  return _gistResolver = _interopRequireDefault(__webpack_require__(146));
}

var _bitbucketResolver;

function _load_bitbucketResolver() {
  return _bitbucketResolver = _interopRequireDefault(__webpack_require__(416));
}

var _hostedGitResolver;

function _load_hostedGitResolver() {
  return _hostedGitResolver = __webpack_require__(66);
}

var _registryResolver;

function _load_registryResolver() {
  return _registryResolver = _interopRequireDefault(__webpack_require__(418));
}
